  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden -z-10">
        ...
        <div className="absolute top-3/4 left-1/2 w-72 h-72 bg-comedy-blue opacity-10 rounded-full blur-3xl"></div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1">
            ...
            <h1 className="font-heading text-4xl md:text-6xl lg:text-7xl font-extrabold mb-6">
              <span className="gradient-text">Kunal Kamra</span>
              <br />
            ...
            <div className="mt-8 p-4 rounded-lg border border-comedy-orange/20 bg-comedy-orange/5 max-w-md">
          ...
          <div className="order-1 lg:order-2 relative">
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-comedy-orange opacity-25 rounded-full blur-3xl -z-10"></div>
